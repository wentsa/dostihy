...
public class VolbaHracu extends javax.swing.JPanel implements Serializable {
    ...
    private void initComponents() {
        ...
        jButton1.setText(bundle.getString("PLAY")); // NOI18N
        ...
        jLabel1.setText(bundle.getString("NUMBER_OF_PLAYERS")); // NOI18N
        ...
        jLabel3.setText(bundle.getString("COLOR")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!vyplnJmena(jmena)) {
            JOptionPane.showMessageDialog(this, bundle.getString("EMPTY_NICK_WARNING"));
            return;
        }
        vyplnBarvy(barvy, jmena.size());
        if (duplicityBarev(barvy)) {
            JOptionPane.showMessageDialog(this, bundle.getString("SAME_COLOR_WARNING"));
            return;
        }
        if (duplicityJmen(jmena)) {
            JOptionPane.showMessageDialog(this, bundle.getString("SAME_NICK_WARNING"));
            return;
        }
        data.barvy = barvy;
        data.jmena = jmena;
    ...
    private boolean duplicityBarev(List<String> barvy) {
        for (int i = 0; i < barvy.size(); i++) {
            for (int k = i + 1; k < barvy.size(); k++) {
                if (barvy.get(i).equals(barvy.get(k))) {
                    return true;
                }
            }
        }
